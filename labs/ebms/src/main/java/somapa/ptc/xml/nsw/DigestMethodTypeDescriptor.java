...
**/
public class DigestMethodTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DigestMethodTypeDescriptor() {
        super();
        nsURI = "http://www.w3.org/2000/09/xmldsig#";
        xmlName = "DigestMethodType";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                DigestMethodType target = (DigestMethodType) object;
        ...
        fieldValidator = new FieldValidator();
    } //-- somapa.ptc.xml.nsw.DigestMethodTypeDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.DigestMethodType.class;
