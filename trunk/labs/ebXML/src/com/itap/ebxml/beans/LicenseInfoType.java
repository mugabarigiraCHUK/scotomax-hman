...
public class LicenseInfoType {
    ...
    public String toString() {
    	StringBuffer stmt = new StringBuffer("LicenseInfoType");
    	stmt.append("[");
    	stmt.append("licenseNo:M:"+licenseNo).append(",");
    	stmt.append("taxReference:M:"+taxReference).append(",");
    	stmt.append("licenseType:M:"+licenseType).append(",");
    	stmt.append("issueDate:M:"+issueDate).append(",");
    	stmt.append("countryCode:O:"+countryCode).append(",");
    	stmt.append("consignmentInfo:M:"+consignmentInfo.toString()).append(",");
    	stmt.append("effectiveDate:M:"+effectiveDate).append(",");
    	stmt.append("expireDate:M:"+expireDate).append(",");
    	stmt.append("authorityID:O:"+authorityID).append(",");
    	stmt.append("authorityName:O:"+authorityName).append(",");
    	stmt.append("licenseName:M:"+licenseName).append(",");
    	stmt.append("authorityName:O:"+authorityName).append(",");
    	stmt.append("inspectionLevel:O:"+inspectionLevel).append(",");
    	stmt.append("inspectionDesc:O:"+inspectionDesc);
    	stmt.append("]");
