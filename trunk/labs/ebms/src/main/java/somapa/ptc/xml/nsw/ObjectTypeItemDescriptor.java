...
**/
public class ObjectTypeItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ObjectTypeItemDescriptor() {
        super();
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                ObjectTypeItem target = (ObjectTypeItem) object;
    ...
    } //-- somapa.ptc.xml.nsw.ObjectTypeItemDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.ObjectTypeItem.class;
