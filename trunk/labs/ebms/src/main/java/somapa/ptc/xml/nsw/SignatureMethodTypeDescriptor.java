...
**/
public class SignatureMethodTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SignatureMethodTypeDescriptor() {
        super();
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                SignatureMethodType target = (SignatureMethodType) object;
    ...
    } //-- somapa.ptc.xml.nsw.SignatureMethodTypeDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.SignatureMethodType.class;
