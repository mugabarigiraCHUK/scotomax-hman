...
public class ReferenceTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReferenceTypeDescriptor() {
        ...
        //-- _digestMethod
        desc = new XMLFieldDescriptorImpl(DigestMethod.class, "_digestMethod", "DigestMethod", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReferenceType target = (ReferenceType) object;
                    target.setDigestMethod( (DigestMethod) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- somapa.ptc.xml.nsw.ReferenceTypeDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.ReferenceType.class;
