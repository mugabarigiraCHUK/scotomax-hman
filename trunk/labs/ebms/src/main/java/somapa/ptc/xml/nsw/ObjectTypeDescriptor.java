...
public class ObjectTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ObjectTypeDescriptor() {
        ...
        //-- _mimeType
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_mimeType", "MimeType", NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
        ...
        //-- _encoding
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_encoding", "Encoding", NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
        ...
        //-- _items
        desc = new XMLFieldDescriptorImpl(somapa.ptc.xml.nsw.ObjectTypeItem.class, "_items", (String)null, NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ObjectType target = (ObjectType) object;
                    target.addObjectTypeItem( (somapa.ptc.xml.nsw.ObjectTypeItem) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new somapa.ptc.xml.nsw.ObjectTypeItem();
            }
        } );
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new somapa.ptc.xml.nsw.ObjectTypeItemDescriptor());
    ...
    } //-- somapa.ptc.xml.nsw.ObjectTypeDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.ObjectType.class;
