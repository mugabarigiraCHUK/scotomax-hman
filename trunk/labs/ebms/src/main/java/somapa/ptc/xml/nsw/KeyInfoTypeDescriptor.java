...
public class KeyInfoTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public KeyInfoTypeDescriptor() {
        ...
        //-- _items
        desc = new XMLFieldDescriptorImpl(somapa.ptc.xml.nsw.KeyInfoTypeItem.class, "_items", (String)null, NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    KeyInfoType target = (KeyInfoType) object;
                    target.addKeyInfoTypeItem( (somapa.ptc.xml.nsw.KeyInfoTypeItem) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new somapa.ptc.xml.nsw.KeyInfoTypeItem();
            }
        } );
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new somapa.ptc.xml.nsw.KeyInfoTypeItemDescriptor());
    ...
    } //-- somapa.ptc.xml.nsw.KeyInfoTypeDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.KeyInfoType.class;
