...
**/
public class CanonicalizationMethodTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CanonicalizationMethodTypeDescriptor() {
        super();
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                CanonicalizationMethodType target = (CanonicalizationMethodType) object;
        ...
        fieldValidator = new FieldValidator();
    } //-- somapa.ptc.xml.nsw.CanonicalizationMethodTypeDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.CanonicalizationMethodType.class;
