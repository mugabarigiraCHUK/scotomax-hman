...
public class X509DataTypeChoiceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public X509DataTypeChoiceDescriptor() {
        ...
        //-- _x509IssuerSerial
        desc = new XMLFieldDescriptorImpl(X509IssuerSerial.class, "_x509IssuerSerial", "X509IssuerSerial", NodeType.Element);
        handler = (new XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    X509DataTypeChoice target = (X509DataTypeChoice) object;
                    target.setX509IssuerSerial( (X509IssuerSerial) value);
                }
                catch (Exception ex) {
    ...
    } //-- somapa.ptc.xml.nsw.X509DataTypeChoiceDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.X509DataTypeChoice.class;
