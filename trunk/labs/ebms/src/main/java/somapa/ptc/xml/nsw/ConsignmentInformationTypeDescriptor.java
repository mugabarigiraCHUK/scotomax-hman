...
**/
public class ConsignmentInformationTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ConsignmentInformationTypeDescriptor() {
        super();
        nsURI = "http://ebxml.customs.go.th/schema/TCDeLicenseInvoice_4_00";
        xmlName = "ConsignmentInformationType";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                ConsignmentInformationType target = (ConsignmentInformationType) object;
    ...
    } //-- somapa.ptc.xml.nsw.ConsignmentInformationTypeDescriptor()
    ...
    **/
    ...
    {
        return somapa.ptc.xml.nsw.ConsignmentInformationType.class;
