...
public class ProductTab extends VerticalLayout 
	...
	// Logging
	private Logger slf4j = LoggerFactory.getLogger(ProductTab.class);
    ...
    public void valueChange(ValueChangeEvent event) {
        if (event.getProperty().getValue() != null) {
            ...
            editor.setValue(tree.getItem(event.getProperty().getValue()).getItemProperty(ExampleUtil.hw_PROPERTY_NAME));
